...
{
    private static Specc.Passes.CompilationContext BuildContext() => PipelineFixtures.AfterGraph();
    ...
    {
        var logger = new Specc.Tests.Fixtures.FakeLogger<Specc.Passes.SemanticGraphPass>();
        var pass   = new Specc.Passes.SemanticGraphPass(logger);
        var ctx    = PipelineFixtures.MakeContext();
