...
public class CfgPass : ICompilerPass
{
    ...
    private static List<CfgBlock> LowerFlatLoop(Specc.Graph.SemanticGraph graph)
    {
    ...
    private static List<CfgBlock> LowerComparisonBranch(Specc.Graph.SemanticGraph graph)
    {
    ...
    private static List<CfgBlock> LowerLinear(Specc.Graph.SemanticGraph graph)
    {
    ...
    private static List<CfgBlock> LowerWhileLoop(Specc.Graph.SemanticGraph graph, WhileLoopNode wl)
    {
        var blocks = new List<CfgBlock>();
    ...
    private static List<CfgBlock> LowerInteractiveWhileLoop(
        Specc.Graph.SemanticGraph graph, WhileLoopNode wl)
    {
        var program = graph.Nodes.OfType<ProgramNode>().FirstOrDefault();
        var nodeIndex = graph.Nodes.ToDictionary(n => n.Id);
    ...
    private static List<CfgBlock> LowerSelectionSort(Specc.Graph.SemanticGraph graph, ArrayNode arr)
    {
    ...
    private static List<CfgBlock> LowerBubbleSort(Specc.Graph.SemanticGraph graph, ArrayNode arr)
    {
        var loop = graph.Nodes.OfType<LoopNode>().FirstOrDefault()
